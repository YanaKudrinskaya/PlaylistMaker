...
Музыкальное приложение для поиска треков, создания плейлистов и прослушивания музыки через iTunes API. Используется предварительный просмотр трека длиной 30 секунд.
